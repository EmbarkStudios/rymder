...
pub mod sdk_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Call when the GameServer is ready"]
        pub async fn ready(
            &mut self,
        ...
        #[doc = " Call to self Allocation the GameServer"]
        ...
        #[doc = " Call when the GameServer is shutting down"]
        ...
        #[doc = " Send a Empty every d Duration to declare that this GameSever is healthy"]
        pub async fn health(
            &mut self,
        ...
        #[doc = " Retrieve the current GameServer data"]
        ...
        #[doc = " Send GameServer details whenever the GameServer is updated"]
        pub async fn watch_game_server(
            &mut self,
            request: impl tonic::IntoRequest<super::Empty>,
        ) -> Result<tonic::Response<tonic::codec::Streaming<super::GameServer>>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        #[doc = " Apply a Label to the backing GameServer metadata"]
        ...
        #[doc = " Apply a Annotation to the backing GameServer metadata"]
        ...
        #[doc = " Marks the GameServer as the Reserved state for Duration"]
